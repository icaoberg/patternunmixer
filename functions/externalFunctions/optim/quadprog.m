...
%   first order optimality (large-scale method only) in 
...
%   $Revision: 1.1.6.4 $  $Date: 2007/12/10 21:50:05 $
   ...
   if largescale  && ...
     ...
     warning('optim:quadprog:FullAndMedScale', ...
              ['This problem formulation not yet available for sparse matrices.\n', ...
               'Converting to full matrices and using medium-scale method instead.'])
