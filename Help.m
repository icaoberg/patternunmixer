...
% Last Modified by GUIDE v2.5 10-Jul-2010 17:05:02
...
if(nargin > 3)
    for index = 1:2:(nargin-3),
        ...
        switch lower(varargin{index})
         ...
         case 'version'
          set(handles.heading, 'String', strcat('Pattern Unmixer v',varargin{index+1},' Help'));
        end
    end
end
...
% Make the GUI modal
set(handles.Help,'WindowStyle','modal')
...
% --- Executes when user attempts to close Help.
function Help_CloseRequestFcn(hObject, eventdata, handles)
% hObject    handle to Help (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

if isequal(get(handles.Help, 'waitstatus'), 'waiting')
    % The GUI is still in UIWAIT, us UIRESUME
    uiresume(handles.Help);
else
...
% --- Executes on key press over Help with no controls selected.
function Help_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to Help (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
